...
df.write.format("delta").saveAsTable("external_products", path="abfss://DP700WS_Infy@onelake.dfs.fabric.microsoft.com/First_LH.Lakehouse/Files/external_products")
